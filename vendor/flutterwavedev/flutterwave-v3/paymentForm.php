...
<head>
    ...
    <body>
        ...
        <form method="POST" action="processPayment.php" id="paymentForm">
            ...
            <input type="hidden" name="logo" value="/ibo/logo.png" /> <!-- Replace the value with your logo url (optional) -->
            <input type="hidden" name="title" value="Victor Store" /> <!-- Replace the 3 with your transaction title (optional) -->
