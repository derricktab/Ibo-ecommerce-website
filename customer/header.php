...
$result=mysqli_query($con, "SELECT * FROM customers WHERE id='$customer_id'")or die('Error In Session');
            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <br>
                        <h4 class="font-16"><a href="profile.php"><?php echo strtoupper($firstname); ?> </a> </h4>
                ...
                <div class="content">
                    ...
                    <div class="topbar">
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline float-right mb-0 mr-5 pt-0 mt-0">
