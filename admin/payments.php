...
<head>
  ...
  <title>Payments | IBO Admin </title>
...
<?php
          ...
          $query = "SELECT * FROM payment ORDER BY payment_date ASC";
 ...
 <div class="container-fluid">
        <table class="table table-responsive table-striped">
           ...
           <a class="btn btn-info btn-round add_btn" href="#"><i class="now-ui-icons ui-1_simple-add"></i> Print</a>
