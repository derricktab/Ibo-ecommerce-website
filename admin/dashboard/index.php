...
$result=mysqli_query($con, "select * from admins where admin_id='$session_id'")or die('Error In Session');
$row=mysqli_fetch_array($result);
$username = $row['username'];
 ?>
 
  <title>IBO Admin | Dashboard</title>
