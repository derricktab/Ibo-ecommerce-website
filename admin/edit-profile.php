...
<div class="col-md-8">
    ...
    <div class="card-body">
       <form action="profile.php" method="post">
        ...
        <div class="col-sm-9">
        <input type="text" class="form-control bg-white" name="phonenumber" value="<?php echo $row['phone_number'] ?>">
        </div>
        </div>
        <hr>
        ...
        <div class="row">
        <div class="col-sm-12">
            <input type="submit" name="update_profile" class="btn btn-info " value="Update Profile" >
        </div>
        </div>
        </form>
    </div>
