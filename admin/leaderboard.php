...
<head>
  ...
  <title>LeaderBoard | IBO Admin </title>
   ...
   <br>
        ...
        <table class="table table-responsive table-striped">
            ...
            <?php
              ...
              if($result){
                while($users_array = mysqli_fetch_array($result)) {     
                    foreach($users_array as $agent){
                      echo "<tr>";
                      echo "<td>".$agent."</td>";
                      $user_query = mysqli_query($con, "SELECT * FROM users where refer='$agent'");
                      if($user_query){
                        $number_of_refers = mysqli_num_rows($user_query);
                      }
                      echo "<td>".$number_of_refers."</td>";
                      echo "</tr>"; 
                  }
